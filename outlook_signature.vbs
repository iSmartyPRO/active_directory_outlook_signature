...
logoImg = "\\fs-genco.gencoindustry.com\scripts$\outlook_signature\genco_outlook_logo.png"
...
strWebsiteLink	= ObjDoc.Hyperlinks.Add(objSelection.Range, "http://www.gencoindustry.com",,, "www.gencoindustry.com")
...
if (strPhone) Then objSelection.TypeText "T: " & strPhone Else objSelection.TypeText "T: +7 (812) 770-60-01" & typeExtNum End If
if (strFax) Then objSelection.TypeText ", F: " & strFax Else objSelection.TypeText ", F: +7 (812) 770-60-02" End If
...
objSelection.TypeText 
Set objLink = objSelection.Hyperlinks.Add(objSelection.Range, "http://www.gencoindustry.com", , , "http://www.gencoindustry.com") 
  objLink.Range.Font.Bold = false 
...
objSignatureEntries.Add "GENCO - New", objSelection
